  ...
  mutate(
    paso1 = case_when(
      ...
      between(cie10_cod, "D86.0", "D86.2") |
        ...
        cie10_cod %in% c("D86.9", "G47.3", "J82.0") ~ "ENT:CRD",
  ...
  mutate(
    paso1 = case_when(
      ...
      between(cie10_cod, "B18.0", "B18.9") |
        ...
        # M55 - M59: No existe
        # M64: No existe
        between(cie10_cod, "M71.0", "M71.1") |
        between(cie10_cod, "M80.0", "M82.8") |
        between(cie10_cod, "M86.3", "M86.4") |
  ...
  mutate(
    paso1 = case_when(
      ...
      cie10_cod %in%
        ...
        between(cie10_cod, "J98.4", "J99.8") ~ "GC3-ENT:CRD",
